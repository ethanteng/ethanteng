...
export const metadata: Metadata = {
  title: "Resume",
  description:
    "Ethan Teng’s experience as Founder of Ask Linc, Engineering Lead / Founding Engineer at Navi Nurses, and creator of Uncloud, plus product and growth leadership.",
};
